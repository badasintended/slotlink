...
class JeiRecipeViewer : RecipeViewer, IModPlugin {
    ...
    private object RequestRecipeTransferHandler : IRecipeTransferHandler<RequestScreenHandler, CraftingRecipe> {
        ...
        override fun getContainerClass(): Class<RequestScreenHandler> {
            return RequestScreenHandler::class.java
        }

        override fun getRecipeClass(): Class<CraftingRecipe> {
            return CraftingRecipe::class.java
        }
...
//        private val ingredientManager: IIngredientManager
        ...
        override fun getIngredientUnderMouse(containerScreen: RequestScreen<*>, mouseX: Double, mouseY: Double): Any? {
